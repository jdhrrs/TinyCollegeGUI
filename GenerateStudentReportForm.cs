...
{
    public partial class GenerateStudentReportForm : Form
    {
        private string connectionString;

        public GenerateStudentReportForm()
        {
            InitializeComponent();
            connectionString = ConfigurationManager.ConnectionStrings["TinyCollegeDB"].ConnectionString;
        }

        private void GenerateStudentReportForm_Load(object sender, EventArgs e)
        {
        ...
        private void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            var dataTable = GetStudentReportData(criteria);
        ...
        private DataTable GetStudentReportData(string criteria)
        {
            var dataTable = new DataTable();
            using (var connection = new SqlConnection(connectionString))
            {
                string query = "SELECT * FROM Students WHERE FirstName LIKE @Criteria OR LastName LIKE @Criteria";
